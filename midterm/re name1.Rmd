...
##顧客光顧幾次圓餅圖
once <- table(M_14_3$customer_unique_id) %>% data.frame()
ggplot(once)+geom_bar(aes(x=factor(1) ,fill=factor(Freq)
                 )) + coord_polar(theta = "y")+ theme_void() +labs(title = "顧客銷售次數圓餅圖")
