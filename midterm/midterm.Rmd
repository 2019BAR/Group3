...
```{r results='hide', message=FALSE, warning=FALSE, echo=F}
###工具
packages = c("dplyr","stringr","readr","ggplot2","scales","mapdata","maps","Imap","factoextra","lubridate","leaflet","geojsonio")
...
str(M_9)
class(M_9[,8])
M_9[,8]=as.POSIXct(M_9[,8], format="%Y-%m-%d")
M_9$time <- format(M_9$order_purchase_timestamp,"%Y%m")
